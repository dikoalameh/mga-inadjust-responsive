    ...
    public function run(): void
    {
        DB::table('tbl_forms')->insert([
            ...
            [
                ...
                'form_view' => 'erb-reviewer/forms/form2e',
                'form_type' => 'Forms',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                ...
                'form_view' => 'erb-reviewer/forms/form2j',
                'form_type' => 'Forms',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                ...
                'form_view' => 'student/forms/form3a',
                'form_type' => 'Forms',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'FORM 3(A) Soft Copy',
                'form_name' => 'Resubmission',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                ...
                'form_code' => 'FORM 3(B)',
                'form_name' => 'REVIEW OF RESUBMITTED STUDY PROTOCOL FORM',
                'form_view' => 'student/forms/form3b',
                'form_type' => 'Forms',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'FORM 3(B) Soft Copy',
                'form_name' => 'REVIEW OF RESUBMITTED STUDY PROTOCOL FORM',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                ...
                'form_code' => 'FORM 3(D)',
                'form_name' => 'APPLICATION FOR REVIEW OF AMENDMENT',
                'form_view' => 'student/forms/form3d',
                'form_type' => 'Forms',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'FORM 3(D) Soft Copy',
                'form_name' => 'REVIEW OF RESUBMITTED STUDY PROTOCOL FORM',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                ...
                'form_view' => 'student/forms/form3e',
                'form_type' => 'Forms',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'FORM 3(E) Soft Copy',
                'form_name' => 'Amendments',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                ...
                'form_code' => 'FORM 2(E) Soft Copy',
                'form_name' => 'Accomplished FORM 2(E) Form',
                'form_view' => 'erb-reviewer/submit-documents',
                'form_type' => 'Submission',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'FORM 2(J) Soft Copy',
                'form_name' => 'Accomplished FORM 2(J) Form',
                'form_view' => 'erb-reviewer/submit-documents',
                'form_type' => 'Submission',
                'created_at' => now(),
                'updated_at' => now(),
                ...
                'form_code' => 'FORM 3(C)',
                'form_name' => 'MCUERB FORM 3(C) Progress Reports',
                'form_view' => 'student/forms/form3c',
                'form_type' => 'Forms',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'FORM 3(L)',
                'form_name' => 'MMCUERB FORM 3(L) Final Reports',
                'form_view' => 'student/forms/form3l',
                'form_type' => 'Forms',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'Final Thesis Manuscript',
                'form_name' => 'Final Thesis Manuscript Soft Copy',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'IMRAD format of Final Thesis',
                'form_name' => 'IMRAD format of Final Thesis Soft Copy',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'Plagiarism certification',
                'form_name' => 'Plagiarism certification Soft Copy',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'Grammar certification',
                'form_name' => 'Grammar certification Soft Copy',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'FORM 3(L) Soft Copy',
                'form_name' => 'Completed MCUERB FORM 3(L) Final Reports Soft Copy',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                'updated_at' => now(),
            ],[
                'form_code' => 'FORM 3(C) Soft Copy',
                'form_name' => 'Completed MCUERB FORM 3(C) Progress Reports Soft Copy',
                'form_view' => 'student/submit-form-layout',
                'form_type' => 'Submission',
                'created_at' => now(),
                'updated_at' => now(),
