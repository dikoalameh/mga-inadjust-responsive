        ...
        <table id="myTable" class="display overflow-scroll border-collapse w-full">
            ...
            <thead class="bg-primary text-white text-lg/7 max-lg:text-base/7">
                <tr class="header-table">
                    ...
                    <th class="w-[25.00%]">Endorsement Letter File</th>
        ...
        <div class="grid grid-cols-2 max-md:grid-cols-1 max-md:block gap-x-5">
            <div class="max-md:mt-3 bg-lightgray shadow-md rounded-md p-3">
                ...
                <div class="gap-x-2 gap-y-3">
                    <ul id="selectedUsers"
                        class="max-md:text-sm flex grid grid-cols-3 max-md:grid-cols-2 list-disc pl-5"></ul>
                </div>
            </div>
            <div class="max-md:mt-3 bg-lightgray shadow-md rounded-md p-3">
                ...
                <div class="max-sm:mb-2 max-sm:text-sm grid grid-cols-3">
                    <div class="flex gap-x-1">
                        <input type="radio" name="reviewClassification" value="ERB"
                            class="mt-1 w-[14px] h-[14px] max-sm:w-[12px] max-sm:h-[12px]">
                        <span>ERB</span>
                    </div>
                    <div class="flex gap-x-1">
                        <input type="radio" name="reviewClassification" value="IACUC"
                            class="mt-1 w-[14px] h-[14px] max-sm:w-[12px] max-sm:h-[12px]">
                        <span>IACUC</span>
                    </div>
                    <div class="flex gap-x-1">
                        <input type="radio" name="reviewClassification" value="ERB/IACUC"
                            class="mt-1 w-[14px] h-[14px] max-sm:w-[12px] max-sm:h-[12px]">
                        <span>ERB/IACUC</span>
                    </div>
                </div>
