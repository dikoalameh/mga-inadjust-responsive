    ...
    <main class="xl:ml-[335px] max-xl:ml-auto p-4 max-md:p-2">
        ...
        <table id="myTable" class="display overflow-scroll border-collapse w-full">
            ...
            <thead class="bg-primary text-white text-lg/7 max-lg:text-base/7">
                <tr class="header-table">
                    ...
                    <th class="w-[15%]">Endorsement Letter File</th>
                    <th class="w-[15%]">Receipts File</th>
                    <th class="w-[15%]">Date Classified</th>
                    ...
                    <tr data-user-id="{{ $user->user_ID }}">
                        ...
                        <td>
                            @if($user->researchInformation?->research_Endorsement)
                                <a href="{{ asset('storage/' . $user->researchInformation->research_Endorsement) }}" target="_blank">
                        ...
                        <td>
                            @if($user->researchInformation?->research_Receipts)
                                <a href="{{ asset('storage/' . $user->researchInformation->research_Receipts) }}" target="_blank">
                                    <button type="button" class="border-2 px-[10px] py-[5px] hover:bg-gray">View</button>
                                </a>
                            @else
                                N/A
        ...
        <div class="grid grid-cols-2 max-md:grid-cols-1 max-md:block gap-x-5 mt-4">
            ...
            <div class="max-md:mt-3 bg-lightgray shadow-md rounded-md p-3">
                ...
                <div class="h-20 max-sm:mb-2 max-sm:text-sm grid grid-cols-3 gap-x-2">
