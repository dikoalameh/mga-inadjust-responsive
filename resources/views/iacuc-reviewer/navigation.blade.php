    ...
    <ul class="mt-12 flex-1 text-[18px]">
        ...
        <li>
            <a href="{{ url('/iacuc-reviewer/monitoring-process') }}"
                class="flex items-center justify-between px-3 py-4 transition-all duration-200 hover:text-secondary {{ Request::is('iacuc-reviewer/monitoring-process') ? 'text-secondary' : ''}}">
