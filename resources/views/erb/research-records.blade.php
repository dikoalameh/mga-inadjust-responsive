        ...
        <table id="myTable" class="display overflow-scroll border-collapse w-full">
            ...
            <thead class="bg-primary text-white text-lg/7 max-sm:text-base/7">
                ...
                <tr class="header-table">
                    ...
                    <th class="w-[10.00%]">Protocol No.</th>
            ...
            <tbody class="text-base/7 max-lg:text-sm/6">
                ...
                <tr>
                    ...
                    @php
                        // Get the protocol(s) assigned to this user's initial reviews
                        $protocol = optional($research->user->initialReviews->first()->protocol ?? null)?->protocol_ID;
                    @endphp
                    <td>{{ $protocol ?? 'N/A' }}</td>
                    <td>Expedited</td>
                    <td>Thomas Hardy</td>
