...
<body class="p-8 text-sm font-arial">
    ...
    <div class ="flex flex-col border">
        ...
        <div class = "flex items-center border-t">
            ...
            <p class = "text-sm text-l mb-2">{{ $protocol->institution }}</p>
        </div>
        <div class = "flex items-center border-t">
            <div class = "px-2 w-1/4 border-r">
                <p class = "text-sm font-bold text-l mb-2">Address of Institution</p>
            </div>
            <p class = "text-sm text-l mb-2">{{ $protocol->institute_address }}</p>
        </div>
        <div class = "flex items-center border-t">
            <div class = "px-2 w-1/4 border-r">
                <p class = "text-sm font-bold text-l mb-2">Ethics Review Board Contact</p>
            </div>
            <p class = "text-sm text-l mb-2">{{ $protocol->erb_contact }}</p>
        </div>
    </div>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->participant_selection }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->participation }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->duration }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->risks_hazards }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->benefits }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->injury_management }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->compensation }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->confidentiality }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->right_to_refuse }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->title_name }}</p>

    <p class = "text-sm text-center mt-4">Institution:</p>

    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->institution }}</p>

    <p class = "text-sm text-center mt-4">Contact numbers:</p>

    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->pi_contact }}</p>

    <p class = "text-sm text-center mt-4">Email Addresses:</p>

    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->pi_email }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->approval_mcueerb }}</p>
    ...
    <p class = "text-sm w-full flex flex-wrap underline text-justify mt-2">{{ $protocol->contact_mcueerb }}</p>
        ...
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                ...
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q1 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q1 === 'No')✓@endif
                </div>
            </div>
        </div>
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q2 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q2 === 'No')✓@endif
                </div>
            </div>
        </div>
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q3 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q3 === 'No')✓@endif
                </div>
            </div>
        </div>
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q4 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q4 === 'No')✓@endif
                </div>
            </div>
        </div>
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q5 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q5 === 'No')✓@endif
                </div>
            </div>
        </div>
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q6 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q6 === 'No')✓@endif
                </div>
            </div>
        </div>
    </div>
    ...
    <div class = "flex flex-col border">
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q7 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q7 === 'No')✓@endif
                </div>
            </div>
        </div>
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q8 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q8 === 'No')✓@endif
                </div>
            </div>
        </div>
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q9 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q9 === 'No')✓@endif
                </div>
            </div>
        </div>
        <div class ="flex items-stretch border-t">
            ...
            <div class="px-2 w-1/6 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q10 === 'Yes')✓@endif
                </div>
            </div>
            <div class="px-2 w-1/6 flex justify-center items-center">
                <!---edit mo yung variable at condition-->
                <div class="w-4 h-4 border border-black flex items-center justify-center text-[10px] leading-none">
                    @if($protocol->consent_q10 === 'No')✓@endif
                </div>
            </div>
        </div>
    </div>
