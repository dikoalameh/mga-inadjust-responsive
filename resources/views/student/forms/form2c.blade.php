...
<x-student-layout>
    <main class="xl:ml-[335px] max-xl:ml-auto p-4 max-md:p-2">
        <form action="{{ route('form2c.store') }}" method="POST" class="block">
            @csrf
            ...
            <div class="mt-3 p-1 max-w-7xl w-full bg-lightgray rounded mx-auto shadow-md">
                ...
                <div
                    ...
                    <div class="flex flex-col md:basis-1/2 w-full">
                        ...
                        <input type="tel" name="pi_contact" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" value="{{ old('pi_contact', $form2c->pi_contact ?? '') }}"
                ...
                <div
                    ...
                    <div class="flex flex-col md:basis-1/3 w-full">
                        ...
                        <input type="text" name="institution" value="{{ old('institution', $form2c->institution ?? '') }}"
                            class="mt-1 rounded border border-darkgray w-full text-sm max-sm:text-[13px] h-[35px] max-lg:h-[30px]"
                            required>
                    </div>
                    <div class="flex flex-col md:basis-1/3 w-full">
                        ...
                        <input type="text" name="institute_address" value="{{ old('institute_address', $form2c->institute_address ?? '') }}"
                            class="mt-1 rounded border border-darkgray w-full text-sm max-sm:text-[13px] h-[35px] max-lg:h-[30px]"
                            required>
                    </div>
                    <div class="flex flex-col md:basis-1/3 w-full">
                        ...
                        <input type="text" name="erb_contact" value="{{ old('erb_contact', $form2c->erb_contact ?? '') }}"
                            class="mt-1 rounded border border-darkgray w-full text-sm max-sm:text-[13px] h-[35px] max-lg:h-[30px]"
                            required>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col md:basis-1/4 w-full">
                                    ...
                                    <input type="text" name="title_name" value="{{ old('title_name', $form2c->title_name ?? '') }}"
                                        class="mt-1 rounded border border-darkgray w-full text-sm max-sm:text-[13px] h-[35px] max-lg:h-[30px]"
                                        required>
                                </div>
                                <div class="flex flex-col md:basis-1/4 w-full">
                                    ...
                                    <input type="text" name="institution" value="{{ old('institution', $researchInfo->research_school ?? '') }}"
                                        class="mt-1 rounded border border-darkgray w-full text-sm max-sm:text-[13px] h-[35px] max-lg:h-[30px]"
                                        required>
                                </div>
                                <div class="flex flex-col md:basis-1/4 w-full">
            ...
            @php
                // Assuming $form2c is retrieved based on the current user
                $hasSavedForm = !empty($form2c); 
            @endphp
            <!-- BUTTONS -->
            <div class="mt-3 p-1 max-w-7xl w-full bg-lightgray rounded mx-auto shadow-md">
