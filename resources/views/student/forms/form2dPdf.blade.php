...
<body class="p-8 text-sm font-arial">
    <h1 class="text-xl font-times font-black text-center mb-6">MCUERB FORM 2(D) Informed Consent Checklist for Principal
        Investigator</h1>

    <x-formbanner>MCUERB FORM 2(D) Informed Consent Checklist for Principal Investigator</x-formbanner>

    <h1 class="text-base font-bold text-center underline mb-4">INFORMED CONSENT CHECKLIST FOR PRINCIPAL INVESTIGATOR
    </h1>
    ...
    <p class="text-sm w-full text-justify mt-2">
        ...
        To facilitate the evaluation of the assessment point, indicate the page and paragraph where this information can
        be found.
    </p>
    ...
    <div class="flex flex-col border">
        <div class="flex items-stretch bg-[#9ca3af]">
            ...
            <p class="text-xs font-bold text-center m-1 w-[41%]">Page and paragraph where component is found</p>
        </div>
        ...
        <div class="flex items-stretch border-t">
            <div class="px-2 w-5/6 border-r">
                <p class="text-sm text-l mb-2">• Explanation to the study participants why they were included in the
                    study</p>
            </div>
            <div class="px-2 w-16 border-r flex justify-center items-center">
                <!---edit mo yung variable at condition-->
    ...
    <div class="flex flex-col border">
        ...
        <div class="flex items-stretch border-t">
            <div class="px-2 w-5/6 border-r">
                <p class="text-sm text-l mb-2">• Disclosure of the anticipated risks and benefits to the study
        ...
        <div class="flex items-stretch border-t">
            <div class="px-2 w-5/6 border-r">
                <p class="text-sm text-l mb-2">• Statements indicating the potential benefits to the community or to
        ...
        <div class="flex items-stretch border-t">
            <div class="px-2 w-5/6 border-r">
                <p class="text-sm text-l mb-2">• Provisions for the mitigation of risks in the protocol consistent with
        ...
        <div class="flex items-stretch border-t">
            <div class="px-2 w-5/6 border-r">
                <p class="text-sm text-l mb-2">• Lists of alternative procedure(s) or course(s) of treatment that may be
        ...
        <div class="flex items-stretch border-t">
            <div class="px-2 w-5/6 border-r">
                <p class="text-sm text-l mb-2">• Statement indicating if there are any anticipated expenses to the study
        ...
        <div class="flex items-stretch border-t">
            <div class="px-2 w-5/6 border-r">
                <p class="text-sm text-l mb-2">• Statement that the records identifying the participant will be kept
    ...
    <div class="flex flex-col border">
        ...
        <div class="flex items-stretch border-t">
            <div class="px-2 w-5/6 border-r">
                <p class="text-sm text-l mb-2">• Manifestation that the language and presentation of the information to
                    be conveyed appropriate to the study participant</p>
                <p class="text-sm text-l mb-2">(Consider the level of complexity and the need for translation into a
